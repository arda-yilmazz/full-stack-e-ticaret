        ...
        <header>
                    ...
                    <a href="/">
                        <svg width="171" height="28" viewBox="0 0 171 28" xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                fill="#FF6000" fillRule="evenodd"></path>
                        </svg>
                    </a>
                </div>
            </div>
                        ...
                        <ul>
                            {categories.map(c => (
                                <li key={c.category_id}>
                                    <a href={`/${c.category_slug}`}>{c.category_name}</a>
                                </li>
                            ))}
                        </ul>
                    </li>
            ...
            <div className="right">
                <div className="buttons">
                    {!user && (
                        <div className="buttons">
                            <button onClick={() => openPopup("login")}>Giriş Yap</button>
                            <button onClick={() => openPopup("register")}>Kayıt Ol</button>
                        </div>
                    )}
            ...
            {open && <Popup name={name} setOpen={setOpen} setName={setName} />}
